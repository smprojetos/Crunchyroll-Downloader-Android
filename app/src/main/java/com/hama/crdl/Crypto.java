...
public class Crypto {
    ...
    private void initCipher() throws CryptoException {
        Security.addProvider(new org.spongycastle.jce.provider.BouncyCastleProvider()); //org.bouncycastle.jce.provider.BouncyCastleProvider
